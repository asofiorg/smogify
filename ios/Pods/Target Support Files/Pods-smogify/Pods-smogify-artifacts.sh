...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/MapboxCommon/MapboxCommon.xcframework" "" "true" "ios-arm64_armv7/MapboxCommon.framework" "ios-arm64_i386_x86_64-simulator/MapboxCommon.framework" "ios-arm64_x86_64-maccatalyst/MapboxCommon.framework"
  install_xcframework "${PODS_ROOT}/MapboxCoreMaps/MapboxCoreMaps.xcframework" "" "true" "ios-arm64/MapboxCoreMaps.framework" "ios-x86_64-maccatalyst/MapboxCoreMaps.framework" "ios-arm64_x86_64-simulator/MapboxCoreMaps.framework"
